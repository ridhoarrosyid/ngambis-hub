...
import { storeProjects } from '@/routes';
...
export default function CreateProject({ categories }: CreateProjectProps) {
            ...
            <div className="container mx-auto max-w-3xl px-4 py-10">
                ...
                <div className="mb-6 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Isi formulir di bawah untuk mempublikasikan karyamu.</p>
                    </div>
                </div>
...
// Menerapkan Layout
CreateProject.layout = (page: React.ReactNode) => <AppLayout children={page} />;
